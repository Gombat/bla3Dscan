/*****************************************************************
Using example code for the STMicro L6470 dSPIN stepper motor driver.
...
FILENAMES
dSPIN.ino - This file. Pin redefinition constants, setup()
  and loop().
...
#define dSPIN_RESET      22  // Wire this to the STBY line
#define dSPIN_BUSYN      24  // Wire this to the BSYN line
...
void setup() 
{
  ...
  dSPIN_SetParam(dSPIN_ACC, AccCalc(1));
  dSPIN_SetParam(dSPIN_DEC, DecCalc(1));
